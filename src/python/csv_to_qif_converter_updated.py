...
def convert_csv_to_qif_bing_format(csv_file_path, qif_file_path, security_list_path):
    ...
    with open(csv_file_path, 'r', encoding='utf-8-sig') as csv_file, open(qif_file_path, 'w', encoding='utf-8') as qif_file:
        ...
        for row in reader:
            ...
            # Add Price, Quantity, Total Amount based on transaction type
...
csv_file_path = 'C:\DEV\Personal\Projects\csv-to-qif\data\TransactionHistory_22114431 - Interest Only - 2023-10-01 to 2023-12-12.csv'
qif_file_path = 'C:\DEV\Personal\Projects\csv-to-qif\data\TransactionHistory_22114431 - Interest Only - 2023-10-01 to 2023-12-12.qif'
security_list_path = 'C:\DEV\Personal\Projects\csv-to-qif\data\Quicken Export Security List.QIF'

# Perform the conversion
convert_csv_to_qif_bing_format(csv_file_path, qif_file_path, security_list_path)
